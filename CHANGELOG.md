...
-evaluate command
  - fixed a bug where question files without any questions with the `RESULT_ORDER_MATTERS` flag would break the evaluation
...
-query command
  - fixed a bug where longer queries require POST instead of GET
