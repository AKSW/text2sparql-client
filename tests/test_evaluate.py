...
def test_successful_evaluation(
        questions_files: QuestionsFiles,
        responses_files: ResponsesFiles
    ) -> None:
...
def test_output_evaluation(
    ...
    run(command=("evaluate", "api_name", str(questions_files.questions),
                 str(responses_files.responses), "-o", output
                ))
    run_asserting_error(
        command=("evaluate", "api_name", str(questions_files.questions),
                 str(responses_files.responses), "-o", output
                ),
